public class Elby {
    ...
    public String getResponse(String statement) {
        String response = "";
        if(statement.trim().length() == 0) response = "Say something, will you?";
        ...
        || findKeyword(statement, "dog", 0) >= 0){
            response = "You have pets? I like animals, tell me more about them.";
        } else if(findKeyword(statement, "Christopher", 0) >= 0){
            response = "That Chris guy sounds very cool and awesome.";
        }
        else {
    ...
    private String getRandomResponse() {
        ...
        if (whichResponse == 0) {
            ...
            response = "That sounds intriguing, is it really true?";
...
public String transformIMeStatement(String statement) {
   ...
   String lastChar = statement.substring(statement.length() - 1);
    ...
    int posOfYou  = findKeyword(statement, "you",  posI + 1);
    String restOfStatement = statement.substring(posI+1, posOfYou).trim();
